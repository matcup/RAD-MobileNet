...
for model_name in models_to_train:
    ...
    with redirect_stdout(f):
        ...
        print(
            f'Test - Loss: {test_loss:.4f}, Precision: {test_precision:.4f}, Recall: {test_recall:.4f}, F1: {test_f1:.4f}')
...
table_data = [[model, f"{perf['Precision']:.4f}", f"{perf['Recall']:.4f}", f"{perf['F1']:.4f}"]
